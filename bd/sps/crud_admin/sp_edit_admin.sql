        ...
        ELSE
            CASE
                WHEN @err_no = 53000 THEN
                    SET errorMessage = CONCAT('Error: El administrador que desea editar no existe');
                WHEN @err_no = 53001 THEN
                    SET errorMessage = CONCAT('Error: El rol que desea asignar no existe');
                WHEN @err_no = 53002 THEN
                    SET errorMessage = CONCAT('Error: El nombre elegido es muy largo');
